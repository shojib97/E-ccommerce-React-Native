...
export default class CreateProducts extends Component {
  ...
  create () {
    ...
    if (productName !== '' && Price !== '' && categoryVal !== '' && categoryType !== 'Select' && imageUrl !== '') {
      ...
      fetch(`${baseUrl}product/createProducts`, {
        method: 'POST',
        body: JSON.stringify({
          imageUrl,
          name: productName,
  ...
  updateProduct () {
    ...
    if (productName !== '' && Price !== '' && categoryVal !== '' && categoryType !== 'Select' && imageUrl !== '') {
      ...
      fetch(`${baseUrl}product/updateProduct`, {
        method: 'PUT',
        body: JSON.stringify({
          imageUrl,
          name: productName,
          ...
          <View style={styles.ScrollViewContainet}>
            <View style={{ flex: 3, justifyContent: 'center' }}>
              ...
              <View
                ...
                <TouchableOpacity activeOpacity={0.7} onPress={this.showMenu} style={[styles.TextInputView, {
                  width: '49%',
                  ...
                  onClick={() => {
                    this.setState({
                      ...
                      if (this.state.isChecked3) {
                        ...
                        sizeArry.splice(sizeArry.indexOf('Large'), 1)
                      }
                    })
                  }}
